...
import torch as th
from diffusion_openai import logger #, dist_util
from diffusion_openai.video_datasets_nc import load_data
...
def main():
    ...
    data_files = [args.chl_dir, args.u_dir, args.v_dir]
    var_names = ["BLGCHL", "UVEL", "VVEL"]
